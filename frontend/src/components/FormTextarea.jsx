...
export default function FormTextarea({ label, name, register, errors, placeholder, required, rows = 4, className, ...props }) {
  return (
    <div className={cn('space-y-1.5', className)}>
      ...
      <textarea
        ...
        rows={rows}
        className={cn(
          'w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-800 outline-none transition-all resize-none',
